...
<div class="container Productaffichage" id="{{$product->name}} Produit" style="margin-bottom: 50px;box-shadow: 0px 0px 7px -3px rgba(0, 0, 0, 0.75);border: 0px solid #000000;">
  <div class="row">
